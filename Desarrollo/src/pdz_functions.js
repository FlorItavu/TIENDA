...
function NPush(Mensaje, Title){ //notificacion Push
var audio = new Audio();
audio.src = 'src/notificacion.mp3';
Push.create(' ' + Title, { //Titulo de la notificación
                body: Mensaje.substring(0, 100), //Texto del cuerpo de la notificación
                icon: 'img/logo_small.png', //Icono de la notificación
